...
public class AggregatorPanel extends JPanel implements Event {
	...
	public AggregatorPanel(Location upperLeft, Location lowerRight, ArrayList<Radar> radars) {
	  ...
	  public void paint(Graphics g) {
		    ...
		    for(int i = _plotMgr.getPlots().size() - 1; i >= 0 ; --i) {
		    	Plot _plot = _plotMgr.getPlots().get(i);
